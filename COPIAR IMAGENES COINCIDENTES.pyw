...
imagenes_label.grid(row=0, column=0, padx=10, pady=5, sticky="w")
roms_label.grid(row=1, column=0, padx=10, pady=5, sticky="w")
output_label.grid(row=2, column=0, padx=10, pady=5, sticky="w")

imagenes_entry.grid(row=0, column=1, padx=5, pady=5, sticky="w")
roms_entry.grid(row=1, column=1, padx=5, pady=5, sticky="w")
...
imagenes_button.grid(row=0, column=2, padx=5, pady=5, sticky="w")
roms_button.grid(row=1, column=2, padx=5, pady=5, sticky="w")
...
progreso.grid(row=3, column=0, columnspan=3, pady=10)

# Botón para iniciar el proceso
procesar_button = tk.Button(root, text="Procesar Coincidencias", command=procesar_coincidencias)
procesar_button.grid(row=4, column=0, columnspan=3, pady=10)
